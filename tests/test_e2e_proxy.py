    ...
    def test_proxy_error_handling(self):
        ...
        try:
            ...
            assert any(keyword in error_str for keyword in 
                      ["proxy", "connection", "timeout", "unreachable", "failed"])
    ...
    def test_proxy_parameter_propagation(self):
        ...
        for func in functions_to_test:
            try:
                ...
                error_str = str(e).lower()
                expected_keywords = ["proxy", "connection", "timeout", "unreachable", "failed", "video unplayable"]
                assert any(keyword in error_str for keyword in expected_keywords), f"Unexpected error: {error_str}"
